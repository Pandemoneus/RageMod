...
public class DebugCommands {
	...
	private void setlang(Player player, String langString, String levelString) {
		...
		plugin.message.send(player, "Your " + plugin.message.LANGUAGE_NAME_COLOR + plugin.config.NPC_LANGUAGE_NAMES.get(id_Language) + plugin.message.DEFAULT_COLOR + " skill is now " + ChatColor.WHITE + level + ".");
	...
	private void towntp(Player player, String townName) {
		...
		player.teleport(GeneralUtilities.findTeleportLocation(town.centerPoint));
	}

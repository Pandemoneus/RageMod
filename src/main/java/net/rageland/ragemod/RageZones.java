...
public class RageZones {
    ...
    // Capitol
    private Region3D Capitol_RegionA;
    private Region3D Capitol_RegionB;
    ...
    public RageZones (RageMod ragemod, RageConfig config)
    {
    	...
    	Capitol_Portal = GeneralUtilities.getLocationFromCoords(world, config.Capitol_PORTAL_LOCATION);
    	
    	// Load the Travel Zone
    	TZ_Center = GeneralUtilities.getLocationFromCoords(nether, config.Zone_TZ_CENTER);
